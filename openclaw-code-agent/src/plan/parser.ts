...
export class PlanParser {
   ...
   */
  private extractClaudeStyle(output: string): ParseResult | null {
   ...
   */
  private extractMarkdownStyle(output: string): ParseResult | null {
   ...
   */
  private extractNumberedList(output: string): ParseResult | null {
